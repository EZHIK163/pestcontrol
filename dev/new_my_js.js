...
let getData = (() => {
    var _ref2 = _asyncToGenerator(function* (id_scheme_point_control) {
        var params = jQuery.param({
            id_scheme_point_control: id_scheme_point_control
        });
        const response = yield fetch(base_url + '/manager/get-points-on-schema-point-control/?' + params //,
        //{
        //    method: "GET",
        //    headers: {
...
let getPoints = (() => {
    var _ref3 = _asyncToGenerator(function* () {
        const json = yield getData(id_scheme_point_control);
        //console.log(json);
...
var showPoints = (() => {
    var _ref = _asyncToGenerator(function* (id, id_scheme_point_control_local) {
...
var savePoint = (() => {
    var _ref4 = _asyncToGenerator(function* () {
        ...
        var newPoints = points.map(function (point) {
            ...
            console.log(new_x);
            console.log(new_y);
            if ((new_x > point.x + 1 || new_x < point.x - 1 || new_y > point.y + 1 || new_y < point.y - 1) && point.is_new == false || point.is_new == true) {
                point.x = new_x;
                point.y = new_y;
            }
            return point;
