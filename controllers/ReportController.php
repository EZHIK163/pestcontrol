...
//    }
    ...
    public function actionReportDisinfectant() {
        ...
        $templateProcessor = new TemplateProcessor(\Yii::$app->basePath.'/templates/template.docx');
    ...
    public function actionReportPoints() {
        ...
        $templateProcessor = new TemplateProcessor(\Yii::$app->basePath.'/templates/template_point.docx');
