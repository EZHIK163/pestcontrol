...
class m180301_054233_create_file_customer extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->addForeignKey('file_customer_updated_by', 'file_customer',
            'updated_by', 'auth.users', 'id');

        $this->addForeignKey('file_customer_id_file', 'file_customer',
        ...
        $this->addForeignKey('file_customer_type_created_by', 'file_customer_type',
            'created_by', 'auth.users', 'id');

        $this->addForeignKey('file_customer_type_updated_by', 'file_customer_type',
            'updated_by', 'auth.users', 'id');
