...
class m180304_052612_add_file_customer_types extends Migration
{
    ...
    {
        $file_customer_type = \app\entities\FileCustomerTypeRecord::findOne(['code' => 'recommendations']);
        $file_customer_type->delete();

        $file_customer_type = \app\entities\FileCustomerTypeRecord::findOne(['code'    => 'scheme_point_control']);
        $file_customer_type->delete();
